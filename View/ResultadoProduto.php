...
<div class="altura">
	...
	<?php include 'View/BuscaProduto.php'; ?>
		 ...
		 <li class="clean"><?php echo $produtos[$i]->getValor();?></li>
		 <li class="clean"><?php echo str_replace('.',',',$produtos[$i]->getResultado());?></li>
		 <li class="wid"><a class="btn btn-small" href="index.php?opcao=excluir&id=<?php echo $produtos[$i]->getid(); ?>"><i class="icon-trash"></i></a></li>
		 <li class="wid"><a class="btn btn-small" href="index.php?opcao=editar&id=<?php echo $produtos[$i]->getid(); ?>"><i class=" icon-edit"></i></a></li>
         </ul>
            <?php endfor; ?>
            <?php 
